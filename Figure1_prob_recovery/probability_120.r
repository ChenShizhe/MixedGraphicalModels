...
write.table(all.rate[,,1], file=paste("./Estimates/240/","prob240cc.txt",sep=""))

write.table(all.rate[,,2], file=paste("./Estimates/240/","prob240cd.txt",sep=""))

write.table(all.rate[,,3], file=paste("./Estimates/240/","prob240dc.txt",sep=""))

write.table(all.rate[,,4], file=paste("./Estimates/240/","prob240dd.txt",sep=""))
